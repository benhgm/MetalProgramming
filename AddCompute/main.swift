...
//  AddCompute
//
//  Created by Benjamin Ho on 6/6/22.
//
...
func computeWay(arr1: [Float], arr2: [Float]) {
    ...
    // Figure out how many threads to use for the operation
    ...
    // Tell the encoder that it is done encoding. Now we send this off to the gpu
